...
Создаётся доступ с помощью объекта `document` с методом `getElementsByTagName`
...
1. С помощью `JavaScript` реализовать всем известный функционал повеения кнопки, которая убегает от мышки.
    Легкий вариант
...
2. Добавить кнопку на вашем проекте с 1-3 заданий для изменения темы вашего сайта. Спомощью `JavaScript` реализовать изменение темы. Также добавить возможность при повторном нажатии на кнопку поменять тему обратно.
